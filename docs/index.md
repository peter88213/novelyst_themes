...
[Download the latest release (version 4.0.4)](https://github.com/peter88213/novelyst_themes/raw/main/dist/novelyst_themes_v4.0.4.zip)

- Extract the "novelyst_themes_v4.0.4" folder from the downloaded zipfile "novelyst_themes_v4.0.4.zip".
